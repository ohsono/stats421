...
def create_top_10_analysis():
    ...
    # 1. Load Data
    data_path = Path('housing_market_data/processed/all_counties_ranking_zscore.csv')
    ...
    # 2. Get Top 10
    top_10 = df.nlargest(10, 'z_score_final').sort_values('z_score_final', ascending=True) # Ascending for horizontal bar chart
    ...
    bars = ax1.barh(top_10['county'], top_10['z_score_final'], color=bar_colors, edgecolor='black', alpha=0.9)
    
    ax1.set_title('Top 10 Counties by Investment Score (Z-Score)', fontsize=14, fontweight='bold')
    ...
    # Save
    output_file = 'visualizations/top_10_analysis_v1.png'
